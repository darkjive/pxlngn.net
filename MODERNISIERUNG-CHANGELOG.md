# pxlngn.net - Modernisierung der Inhalte

## Übersicht der Änderungen

Alle Marketing-Floskeln und veraltete Formulierungen wurden durch moderne, direkte Dev-Sprache ersetzt.
...
Projekt-Beschreibungen auf das Wesentliche reduziert:

**Vorher:** "TYPO3-basierte Webseite mit Fokus auf Glasfaser-Internet. Projektmanagement mit Scrum-Methodik für agile Entwicklung und kontinuierliche Verbesserung."

**Nachher:** "TYPO3-Website für Glasfaser-Internet. Scrum-basiert entwickelt."

---

## 5. Tech-Stack (`src/data/tech-stack.ts`)

### Alt-Texte gestrafft (Accessibility bleibt, Geschwätz weg):

**Vorher:** "HTML5: Eine Kernsprache für das Erstellen und Strukturieren von Webseiten."

**Nachher:** "HTML5"

**Vorher:** "TypeScript: Eine typsichere Erweiterung von JavaScript, entwickelt für größere Projekte."

**Nachher:** "TypeScript - JavaScript mit Types"

### Abstract/Services-Sektion komplett überarbeitet:

**Vorher:** "Modulare Weboberflächen mit HTML, CSS und Javascript. Sauberer, wartbarer Code."

**Nachher:** "HTML, CSS, JavaScript. Sauberer Code, wartbar, modular."
...
- Fachbegriffe beibehalten, aber ohne Erklärung (weil Dev-Audience)
- 90er-Background erwähnt
...
- Moderne Dev-Sprache mit 12 Jahren Erfahrung

---

**Fertig!** 🎮

Die modernisierte Version ist bereit zum Deployment.
