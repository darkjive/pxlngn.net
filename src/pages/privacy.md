...
2. **Datenkategorien**: Nutzerdaten, Cookie, Nutzer-ID (inkl. die besuchten Seiten, Geräteinformationen, Zugriffszeiten und IP-Adressen).
...
7. **Widerspruch**: Sie haben gegenüber Google ein Widerspruchsrecht gegen die Bildung von Nutzerprofilen. Bitte richten Sie sich deswegen direkt an Google über die unten genannte Datenschutzerklärung. Ein Opt-Out-Widerspruch hinsichtlich der Werbe-Cookies können Sie hier in Ihrem Google-Account vornehmen: [https://adssettings.google.com/authenticated](https://adssettings.google.com/authenticated).
